...
<style type="text/css">
body {
background: url(images/blackgrad2.jpg) no-repeat scroll 0 0 #fff;
}
...
//		listDiv.style.display = 'block';
	...
	function showDiv2(obj,area)
	{
	   ...
	   $(obj).stop();
		...
		if (w>1370)
		{
		  ...
		  w=(w*.6);
		$('#info_right_grow').animate({ top:"40px",left:(w+'px'),opacity: 0.8,width:'490px',height:"629px"},500,function () { showlisting(w);});
		$('#info_left_grow').animate({ opacity: 0.8,left:woffset,width:'490px',height:"629px"},500,function () {showinfo(woffset);});
		mapOverlay.style.display = 'block';
		mapOverlay.style.width = '100%';
		hght=getHeight();
		mapOverlay.style.height = hght+'px';
	...
	document.getElementById('daily_grow').style.display='none';
	document.getElementById('daily_grow').style.height='1px';
	document.getElementById('daily_grow').style.left='500px';
	...
	function showDaily_full(offset)
	{
		...
		document.getElementById('daily_grow').style.width='1px';
		document.getElementById('daily_grow').style.opacity=0.1;
		document.getElementById('daily_grow').style.top='664px';
		document.getElementById('daily_grow').style.left='500px';
		listDiv = document.getElementById('daily_w');
		listDiv.style.top = '40px';
		listDiv.style.left = offset+'px';
...
//		listDiv.style.display = 'block';
	...
	function hideDetail()
	{
	  ...
	  myListBox.style.display = 'none';
	  myListBox = document.getElementById('info_right_w');
	  myListBox.style.display = 'none';
	  myListBox = document.getElementById('info_left_w');
	  myListBox.style.display = 'none';
...
<div>
<object style="position: absolute; left: 104px; top: 23px; z-index:6;" id="shimmer_list" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" height="200" wmode="transparent">
        ...
        <!--<![endif]-->
          <img src="images/mylist.png" class="hover" style="position: absolute; left: 77px; top: 32px; z-index:5;" onclick="showMyList();" />

      </object>


<object wmode="transparent" style="position: absolute; left: 1050px; top: 19px; z-index: 6;" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" id="shimmer_search" height="200">
        <param name="movie" value="../shimmer_search2.swf" />
        <param name="wmode" value="transparent" />

        <!--[if !IE]>-->
        <embed src="../shimmer_search2.swf" style="position: absolute; z-index: 6;" quality="high" width="300" height="200" wmode="transparent" name="movie" align="" type="application/x-shockwave-flash" plug inspage="http://www.macromedia.com/go/getflashplayer">
<!--<![endif]-->
          <img src="images/mysearch.png" class="hover" style="position: absolute; top: 29px; left: 16px; z-index:5;" onclick="showSearch();" />
...
<!--START MAP-->
  ...
  <div id="gp_contain" style="position:relative; z-index: 0; background: url(images/testriver.png) no-repeat scroll 281px 4px transparent;">
    ...
    <img src="images/avondale.png" width="112" height="138" border="0" usemap="#m42" class="thumb" id="avondale" style="position: absolute; top: 229px; left: 469px; z-index: 5;" />
    <map name="m42" id="m42">
    ...
    <img src="images/vla.png" width="44" height="101" border="0" usemap="#m47" class="thumb" id="vla" style="position: absolute; top: 228px; left: 571px; z-index: 5;" />
    <map name="m47" id="m47">
    ...
    <img src="images/central_business_district.png" width="121" height="80" border="0" usemap="#m48" class="thumb" id="central_business_district" style="position: absolute; top: 329px; left: 531px; z-index: 5;" />
    <map name="m48" id="m48">
    ...
    <map name="m38" id="m38">
      <area shape="rect" coords="2,2,129,62" id="area38" href="javascript:void(0)" onclick="showDiv('#vision_west','area38',47)" />
    </map>
    ...
    <img src="images/canfor.png" width="93" height="109" border="0" usemap="#m10" class="thumb" id="canfor" style="position:absolute; top: 396px; left: 460px; z-index: 5;" />
    <map name="m10" id="m10">
      <area shape="poly" coords="4,9,2,101,5,103,81,102,75,92,80,89,87,89,87,82,90,72,85,71,85,63,89,55,78,57,74,49,77,38,84,26,80,18,77,9,76,2,71,4,65,4,47,4,14,4"  />
    </map>
    ...
    <img src="images/railtown.png" height="82" width="44" border="0" usemap="#m49" class="thumb" id="railtown" style="position:absolute; top: 437px; left: 671px; z-index: 5;" />
    <map name="m49" id="m49">
    ...
    <img src="images/westpointe.png" height="87" width="63" border="0" usemap="#m41" class="thumb" id="westpointe" style="position:absolute; top: 500px; left: 336px; z-index: 6;" />
    <map name="m41" id="m41">
...
<td height="145" valign="bottom" align="right" style="min-width: 100px;">
...
<? }
   ...
   {
?>
<img style="width: 100px; max-width: 100px;" src="/images/<? echo $realtr['brokerage_image'];?>" />
<?
   }
   if ($realtr['brokerage_website']!='') { ?>
</a>
...
?>
<img style="max-width: 250px; max-height: 300px;" src="/images/<? echo $pimage;?>" />
</td>

<td valign="bottom" width="204"><?  if ($realtr['twitter_account']!='') include('twitter2.php'); ?></td>
</tr>

<tr>
<td valign="top" align="center" colspan="3" style="max-width: 215px;"><p style="color: #fff; font-size: 28px; margin: 0 0 0 -80px; font-weight: 600; font-family: 'Myriad Pro', Arial, Helvetica, Sans-serif; text-align: center;text-shadow: 0px 1px 0px #444; line-height: 35px;"><a href="<? echo $realtr['website'];?>" target="_blank" class="realtor_name"><? echo $realtr['firstname'].' '.$realtr['lastname'];?>,<br />My REALTOR<span class="reg_symbol">&reg;</span></a></p></td>
</tr>

</table>
<object style="position: absolute; left: 980px; top: 475px;" id="citygrandeprairielink" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="410" height="91" wmode="transparent">
        <param name="movie" value="images/cityflash.swf" />
        <param name="wmode" value="transparent" />

        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="images/cityflash.swf" id="citygrandeprairielink" width="410" height="91" wmode="transparent">
        <!--<![endif]-->
          <a href="http://www.cityofgp.com" target="_blank"><img src="images/cityofgrandeprairie.png" class="hover" style="position: absolute; left: 980px; top: 475px; width: 381px;" /></a>
        <!--[if !IE]>-->
        </object>
        <!--<![endif]-->
      </object>
...
<a href="/gp_county2/map2.php"><img src="images/tocounty.png" class="hover" style="position:absolute; top: 682px; left: 1180px; width: 111px; height: 99px;" id="area00" href="javascript:void(0)" /></a>


<!--<img src="images/myvideoblog.png" style="position:absolute; left: 74px; top: 205px;" />-->

<img src="images/mydocuments.png" style="position:absolute; left: 73px; top: 244px;" />

<object style="position: absolute; left: 48px; top: 340px; z-index: 6;" id="myservlink" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="150" height="120" wmode="transparent">
        <param name="movie" value="../servicesflash.swf" />
        <param name="wmode" value="transparent" />
        <!--[if !IE]>-->
        <embed style="position:absolute; z-index: 6;" src="../servicesflash.swf" quality="high" width="150" height="120" wmode="transparent" name="movie" align="" type="application/x-shockwave-flash" plug inspage="http://www.macromedia.com/go/getflashplayer">
<!--<![endif]-->
          <a href="javascript:displayservices();"><img src="images/myservbtn.png" class="hover" style="position:absolute; top: 10px; left: 8px; height: 100px; z-index:5;" /></a>

      </object>

      <object style="position: absolute; left: 48px; top: 465px; z-index: 6;" id="myreflink" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="150" height="120" wmode="transparent">
        <param name="movie" value="../referralflash.swf" />
        <param name="wmode" value="transparent" />
        <!--[if !IE]>-->
        <embed src="../referralflash.swf" style="position: absolute; z-index:6;" quality="high" width="150" height="120" wmode="transparent" name="movie" align="" type="application/x-shockwave-flash" plug inspage="http://www.macromedia.com/go/getflashplayer">
        <!--<![endif]-->
          <a href="javascript:displayref();"><img src="images/reficon.png" class="hover" style="position:absolute; top: 10px; left: 25px; height: 100px; z-index: 5;" /></a>

      </object>


            <object style="position: absolute; left: 48px; top: 565px; z-index: 6;" id="dailylink" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="150" height="150" wmode="transparent">
        <param name="movie" value="../dailyflash.swf" />
        <param name="wmode" value="transparent" />

        <!--[if !IE]>-->
        <embed style="position:absolute; z-index: 6;" src="../dailyflash.swf" quality="high" width="150" height="150" wmode="transparent" name="movie" align="" type="application/x-shockwave-flash" plug inspage="http://www.macromedia.com/go/getflashplayer">
<!--<![endif]-->
          <a href="javascript:getNewListings();"><img src="../dailyicon.png" class="hover" style="position:absolute; z-index: 5; top: 31px; left: 26px;" /></a>
...
<table cellpadding="0" cellspacing="0" class="mrn_footer" style="width: 1420px; margin: 0 0 0 -72px; position: absolute; top: 1040px;">
<tr>
...
<?
  ...
  echo ' <a href="'.$url.'" style="font-family: \'Myriad Pro\', Helvetica, Arial, Sans-serif; font-size: 18px; color: #000; text-align: center; font-weight: bold;" class="settings_btn">My Settings</a>';
?>
</td>
</table>
