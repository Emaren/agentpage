...
//		document.getElementById('houseimg').onclick=function () {$("a.fancybox:first").trigger("click");};},1000);
...
<? if ($realtr['website']!='') { ?>
<a href="http://<? echo $realtr['website'];?>" target="_blank" class="logo_link">
<? }
...
?>
<img src="/images/<? echo $pimage;?>" width="175" />
</td>

<td valign="bottom"><? if ($realtr['twitter_account']!='') include('twitter2.php'); ?></td>
</tr>

<tr>
<td></td>
<td valign="top" align="center"><p style="color: #fff; font-size: 28px; margin: 0; font-weight: 600; font-family: 'Myriad Pro', Arial, Helvetica, Sans-serif; text-align: center;text-shadow: 0px 1px 0px #444; line-height: 35px;"><a href="" class="realtor_name"><? echo $realtr['firstname'].' '.$realtr['lastname'];?>,<br />My REALTOR<span class="reg_symbol">&reg;</span></a></p></td>
<td></td>
</tr>
