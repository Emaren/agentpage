...
<body style="background: url(images/blackgrad.png) no-repeat scroll 0% 0 #c2c2c2;">
<div id="all">

<div>
<img src="images/mylist.png" class="hover" style="position: absolute; left: 175px; top: 10px; z-index:100;" onclick="showMyList();" />
<img src="images/mysearch.png" class="hover" style="position: absolute; left: 70%; top: 7px; z-index:100;" onclick="showSearch();" />
</div>
...
<img src="images/cityofgrandeprairie.png" style="position: absolute; top: 90%; left: 20%;" />

</div>
<p style="font-family: 'Myriad Pro', Helvetica, Arial, Sans-serif; font-size: 18px; letter-spacing: -1px; color: #000; text-align: center; position: absolute; top: 81.5%; left: 20px;">&#169;2011 Emaren Technologies Inc. All Rights Reserved.<br />Patent Pending.</p>
...
<div style="width: 260px;position:absolute; top: 383px; left: 0px;">
<img src="images/man.png" />
<p style="color: #fff; font-size: 36px; margin: 10px 0; font-weight: 600; font-family: 'Myriad Pro', Arial, Helvetica, Sans-serif; text-align: center;text-shadow: 0px 1px 0px #444;">Jim Smith,<br />My Realtor</p>
</div>
<img src="images/tocounty.png" class="hover" style="position:relative; top: -492px; left: -95px; float:right;" />
</div>
