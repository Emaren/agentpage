...
//	setTimeout(function () {i.style.zIndex = originalz}, 250);
	...
	function showDiv2(obj,area)
	{
		...
		w=(w*.6);
		w=w+'px';
		$('#info_right_grow').animate({ top:"30.85px",left:w,opacity: 0.8,width:'490px',height:"529px"},500,function () { showlisting();});				
...
<img src="images/mysearch.png" style="width: 25px; position: absolute; top: 440px; left: 96%; z-index:100;" onclick="showSearch();" />
<div id="gp_contain">
