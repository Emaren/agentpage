...
/*	  var browserName=navigator.appName; 
	...
	function showDiv2(obj,area)
	{
		...
		$(obj).css({'z-index' : originalzIndex[name],'width' : originalWidth['#'+name]/1.5, 'height' : originalHeight['#'+name]/1.5});
	...
	function hideDiv(obj,area)
	{
		...
		name = document.getElementById(obj.substr(1)).id;
		top=pos[obj].top;
		$(obj).css({'top' : pos[obj].top-22+'px',left: pos[obj].left,marginLeft:0,marginTop:0,width: originalWidth[obj]/1.5,height: originalHeight[obj]/1.5});
	    hide_info_list();
		mapOverlay = document.getElementById('overlay');
...
<body style="background: url(images/blackgrad.png) no-repeat scroll 0% 0 #c2c2c2;" onload="goToAnchor();">
<div id="all">

<div>
<img src="images/mylist.png" style="position: absolute; left: 175px; top: 10px; z-index:100;" onclick="showMyList();" />
<img src="images/mysearch.png" style="position: absolute; left: 70%; top: 7px; z-index:100;" onclick="showSearch();" />
</div>
...
<center><img src="" id="highlighted" style="position: absolute; z-index: 1000; top: 20%; left: 42%;" /></center>
