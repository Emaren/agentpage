...
//	setTimeout(function () {i.style.zIndex = originalz}, 250);
	...
	function showDiv2(obj,area)
	{
		...
		$('#info_right_grow').animate({ opacity: 0.8,width:'490px',height:"529px"},500,function () { showlisting();});		
...
<!--<map name="m10" id="m10">
  <area shape="poly" coords="4,9,2,87,7,90,71,90,65,85,67,80,72,78,76,77,75,71,80,65,74,61,77,55,76,48,67,51,64,47,64,35,69,28,73,22,70,16,66,9,65,4,47,4,14,4" id="area10" href="javascript:void(0)" onclick="showDiv('#canfor','area10',63)" />
</map>-->
...
<!--<map name="m15" id="m15">
  <area shape="poly" coords="4,4,97,4,103,8,102,52,98,56,31,56,30,47,25,41,18,42,8,33,9,24,13,20,7,18,3,10" id="area15" href="javascript:void(0)" onclick="showDiv('#country_club','area15',12)" />
</map>-->
...
<!--<map name="m24" id="m24">
  <area shape="poly" coords="2,2,2,56,7,60,51,59,53,56,57,52,56,47,56,45,60,47,66,44,65,38,68,33,68,29,80,26,74,23,75,19,82,17,82,10,89,5,89,4" id="area24" href="javascript:void(0)" onclick="showDiv('#grande_banks','area24',62)" />
</map>-->
