<?
  ...
  $use=mysql_fetch_array($res,MYSQL_ASSOC);
   ...
   $form="https://www3.moneris.com/HPPDP/index.php";
   $unit="month";
   $mth=date("m")+1;
   $d=date("d");
   $yr=date("y");
...
<form name="sub" method="POST" action="<? echo $form;?>">
  <INPUT TYPE="HIDDEN" NAME="ps_store_id" VALUE="9QX3917526">
  <INPUT TYPE="HIDDEN" NAME="hpp_key" VALUE="hp2CT73RRO7Z">
  <INPUT TYPE="HIDDEN" NAME="charge_total" VALUE="103.95">
<input type="hidden" name="id1" value="1">
<input type="hidden" name="description1" value="www.realtornow.ca Trial Upgrade">
<input type="hidden" name="quantity1" value="1">
<input type="hidden" name="price1" value="99.00">
<input type="hidden" name="subtotal1" value="99.00">
<INPUT TYPE="HIDDEN" NAME="cust_id" VALUE="<? echo $use['id'];?>">
<INPUT TYPE="HIDDEN" NAME="order_id" VALUE="MRM<? echo $use['id'];?>">
<INPUT TYPE="HIDDEN" NAME="gst" VALUE="4.95">
<INPUT TYPE="HIDDEN" NAME="bill_first_name" VALUE="<? echo $use['firstname'];?>">
<INPUT TYPE="HIDDEN" NAME="bill_last_name" VALUE="<? echo $use['lastname'];?>">
