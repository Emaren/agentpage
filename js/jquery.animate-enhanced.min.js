...
**************************************************/
(function(b,u,q){function z(a,j,c,d){var k=A.exec(j),g=a.css(c)==="auto"?0:a.css(c);g=typeof g=="string"?m(g):g;typeof j=="string"&&m(j);d=d===!0?0:g;var i=a.is(":hidden"),h=a.translation();c=="left"&&(d=parseInt(g,10)+h.x);c=="top"&&(d=parseInt(g,10)+h.y);!k&&j=="show"?(d=1,i&&a.css({display:"block",opacity:0})):!k&&j=="hide"&&(d=0);return k?(a=parseFloat(k[2]),k[1]&&(a=(k[1]==="-="?-1:1)*a+parseInt(d,10)),a):d}function B(a,j,c,d,k,g,n,h){var e=a.data(i)?!o(a.data(i))?a.data(i):jQuery.extend(!0,
...
10)};break}}return j};jQuery.fn.animate=function(a,j,b,d){a=a||{};var k=!(typeof a.bottom!=="undefined"||typeof a.right!=="undefined"),g=jQuery.speed(j,b,d),n=this,h=0,e=function(){h--;h===0&&typeof g.complete==="function"&&g.complete.apply(n,arguments)};if(!y||o(a)||E(a)||g.duration<=0)return u.apply(this,arguments);return this[g.queue===!1?"each":"queue"](function(){var f=jQuery(this),d=jQuery.extend({},g),j=function(){for(var d={},b=c.length-1;b>=0;b--)d[c[b]+"transition-property"]="none",d[c[b]+
"transition-duration"]="",d[c[b]+"transition-timing-function"]="";f.unbind(r);if(!a.leaveTransforms===!0){var j=f.data(i)||{},g={};for(b=c.length-1;b>=0;b--)g[c[b]+"transform"]="";if(k&&typeof j.meta!=="undefined"){b=0;for(var h;h=s[b];++b)g[h]=j.meta[h+"_o"]+"px"}f.css(d).css(g)}a.opacity==="hide"&&f.css("display","none");f.data(i,null);e.call(f)},b={bounce:"cubic-bezier(0.0, 0.35, .5, 1.3)",linear:"linear",swing:"ease-in-out",easeInQuad:"cubic-bezier(0.550, 0.085, 0.680, 0.530)",easeInCubic:"cubic-bezier(0.550, 0.055, 0.675, 0.190)",
...
n={};b=b[d.easing||"swing"]?b[d.easing||"swing"]:d.easing||"swing";for(var l in a)if(jQuery.inArray(l,H)===-1){var m=jQuery.inArray(l,s)>-1,t=z(f,a[l],l,m&&a.avoidTransforms!==!0);a.avoidTransforms!==!0&&F(l,t,f)?B(f,l,d.duration,b,m&&a.avoidTransforms===!0?t+"px":t,m&&a.avoidTransforms!==!0,k,a.useTranslate3d===!0):n[l]=a[l]}l=f.data(i)||{};for(b=c.length-1;b>=0;b--)typeof l[c[b]+"transition-property"]!=="undefined"&&(l[c[b]+"transition-property"]=l[c[b]+"transition-property"].substr(2));f.data(i,
l).unbind(r);if(!o(f.data(i))&&!o(f.data(i).secondary)){h++;f.css(f.data(i));var q=f.data(i).secondary;setTimeout(function(){f.bind(r,j).css(q)})}else d.queue=!1;o(n)||(h++,u.apply(f,[n,{duration:d.duration,easing:jQuery.easing[d.easing]?d.easing:jQuery.easing.swing?"swing":"linear",complete:e,queue:d.queue}]));return!0})};jQuery.fn.stop=function(a,b,m){if(!y)return q.apply(this,[a,b]);a&&this.queue([]);for(var d={},k=c.length-1;k>=0;k--)d[c[k]+"transition-property"]="none",d[c[k]+"transition-duration"]=
"",d[c[k]+"transition-timing-function"]="";this.each(function(){var g=jQuery(this),k=window.getComputedStyle(this,null),h={},e;if(!o(g.data(i))&&!o(g.data(i).secondary)){e=g.data(i);if(b){if(h=e.secondary,!m&&typeof e.meta.left_o!==void 0||typeof e.meta.top_o!==void 0){h.left=typeof e.meta.left_o!==void 0?e.meta.left_o:"auto";h.top=typeof e.meta.top_o!==void 0?e.meta.top_o:"auto";for(e=c.length-1;e>=0;e--)h[c[e]+"transform"]=""}}else for(var f in g.data(i).secondary)if(f=f.replace(I,"-$1").toLowerCase(),
h[f]=k.getPropertyValue(f),!m&&/matrix/i.test(h[f])){e=h[f].replace(/^matrix\(/i,"").split(/, |\)$/g);h.left=e[4]+"px"||"auto";h.top=e[5]+"px"||"auto";for(e=c.length-1;e>=0;e--)h[c[e]+"transform"]=""}g.unbind(r).css(d).css(h).data(i,null)}else q.apply(g,[a,b])});return this}})(jQuery,jQuery.fn.animate,jQuery.fn.stop);