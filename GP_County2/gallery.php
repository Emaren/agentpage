...
function resize()
{
 gimg=document.getElementById('tempimg');
 var aspect = gimg.width / gimg.height;
 if (gimg.width>600)
 {
   gimg.height= gimg.width / aspect;
   gimg.width=600;
  }
  if (gimg.height > 450)
  {
     aspect = gimg.width / gimg.height;
     gimg.width = gimg.height * aspect;
     gimg.height=450;
  }
  document.getElementById('main').src=gimg.src;
  document.getElementById('main').width=gimg.width;
  document.getElementById('main').height=gimg.height;
}
