...
<div id="gp_contain">
<img src="images/test/road1.png" style="position: absolute; top: 325px; left: 525px; z-index: 5;" />
<img src="images/test/road2.png" style="position: absolute; top: 325px; left: 919px; z-index: 5;" />
...
<img src="images/test/college_park.png" border="0" usemap="#m13" width="70" height="101" class="thumb" id="college_park" style="position:absolute; top: 259px; left: 752px; z-index: 1;" />
<map name="m13" id="m13">
...
<img src="images/test/smith.png" border="0" width="55" height="65" usemap="#m35" class="thumb" id="smith" style="position:absolute; top: 327px; left: 922px; z-index: 1;" />
<map name="m35" id="m35">
...
<img src="images/test/central_business_district.png" width="113" height="75" border="0" usemap="#m48" class="thumb" id="central_business_district" style="position: absolute; top: 286px; left: 808px; z-index: 1;" />
<map name="m48" id="m48">
...
<tr>
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="pricesearch">
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="bedssearch">
    ...
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="agesearch">
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="bathsearch">
    	<option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
        <option value="4">4+</option>
        </select></td>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="sizesearch">
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="garagesearch"><option value="1">Attached</option><option value="2">Detatched</option>
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="subdivsearch">
<?
...
<tr>
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="pricesearch">
    <option value="1-50">$1 - $50,000</option>
    <option value="50-100">$50,000 - $100,000</option>
    <option value="100-150">$100,000 - $150,000</option>
    <option value="150-200">$150,000 - $200,000</option>
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="bedssearch">
    	<option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
        <option value="4">4+</option>
    ...
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="agesearch">
    	<option value="0-5">0 - 5</option>
        <option value="5-10">5 - 10</option>
        <option value="10-20">10 - 20</option>
        <option value="20-30">20 - 30</option>
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="bathsearch">
    	<option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
        <option value="4">4+</option>
        </select></td>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" name="sizesearch">
    	<option value="500-1000">500 - 1000 sqft</option>
        <option value="1000-1500">1000 - 1500 sqft</option>
        <option value="1500-2000">1500 - 2000 sqft</option>
        <option value="2000">2000+ sqft</option>
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="garageserch"><option value="1">Attached</option><option value="2">Detatched</option>
	<option  value="3">Single</option><option  value="2">Double</option>
	<option value="1">1.5</option></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="subdivsearch">
<?
   global $municipalityid;
