      ...
      if ($error_msg=='')
      {
       ...
       if ($result and mysql_num_rows($result)>0)
       {
		  ...
		  if ($_POST['redirect']!='')
		  {
			...
			{
			  header('Location: /rd_city/map20a.php');
			  die();
		    }
			if ($_POST['redirect']=='county')
			{
			  header('Location: /rd_county/map2.php');		  		  
		      die();
			}
		  }
		  
          if ($row['isadmin']==1)
            header("Location: ".$web_app_path."rd_users.php");
          else
		    if ($row['realtor']=='y')
              header("Location: ".$web_app_path."rd_users.php");
...
<body style="background:url(images/loginbg.jpg) no-repeat scroll 50% 55px #020101;">
<div id="login_wrap">

<img src="images/loginblurb.png" alt="SEARCHING FOR REAL ESTATE HAS NEVER LOOKED THIS GOOD..." style="margin-bottom: 50px;" />
<br>
<img src="images/myrealtornow_rd_title.png" alt="MYREALTORNOW.CA/RED DEER" style="margin-bottom: 20px;" />
<br>
<img src="images/rd_county_btn.png" name="login" class="county" onClick="document.getElementById('redirect').value='county'; document.forms[0].submit();" />
<img src="images/rd_city_btn.png" name="login" class="city" onClick="document.getElementById('redirect').value='city'; document.forms[0].submit();" />
...
<input type="text" name="username" value="" onKeyPress="checkEnter(event)" />
...
<br>
<br>
<img src="images/rd_login_blurb.png" alt="PRESENTED TO THE RED DEER MARKET EXCLUSIVELY BY EMAREN TECHNOLOGIES" />
<br>
<br>
