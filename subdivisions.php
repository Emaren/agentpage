...
<tr>
<th><a href='<? echo $web_app_path; ?>subdivisions.php?sort=0&dir=<? echo $sort_dir[0]?>'>Municipality&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[0].' border=0>'; ?></a></th>
<th><a href='<? echo $web_app_path; ?>subdivisions.php?sort=1&dir=<? echo $sort_dir[1]?>'>Name&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[1].' border=0>'; ?></a></td>
<th><a href='<? echo $web_app_path; ?>subdivisions.php?sort=2&dir=<? echo $sort_dir[2]?>'>No of Homes&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[2].' border=0>'; ?></a></th>
</tr>

<?
   while ($row=mysql_fetch_array($res,MYSQL_ASSOC))
      echo '<tr><td>'.$row['mname'].'</td><td>'.$row['sname'].'</td><td>'.$row['no_of_homes'].'</td><td><a href='.$web_app_path.'editsubdivision.php?id='.$row['sid'].'>Edit</a></td></tr>';
?>
