...
<?
  if (($_SESSION['realtor']=='y' && $_SESSION['add_client']=='y') or $_SESSION['isadmin']!=0) {
?>
<a href="/edituser.php" style="float:left;" <? if ($_SESSION['realtor']=='y') echo ' class="brown_btn addclient"'; else echo ' class="brown_btn addrealtor"'; ?> ><? if ($_SESSION['realtor']=='y') echo 'Add Client'; else echo 'Add Realtor'; ?></a>
<?
  }
?>
<a style="float:left;margin-top:0px;max-width: 133px; display: block; min-width: 133px;" href="/traffic.php" class="brown_btn traffic" >View Traffic</a>
...
<tr>
<th>&nbsp;</th>
<th><a href='<? echo $web_app_path; ?>users.php?sort=0&dir=<? echo $sort_dir[0]?>'>First Name&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[0].' border=0>'; ?></a></th>
<th><a href='<? echo $web_app_path; ?>users.php?sort=1&dir=<? echo $sort_dir[1]?>'>Last Name&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[1].' border=0>'; ?></a></th>
<th colspan="3"><a href='<? echo $web_app_path; ?>users.php?sort=3&dir=<? echo $sort_dir[3]?>'>Email&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[3].' border=0>'; ?></a></th>
</tr>
...
<?
   while ($row=mysql_fetch_array($res,MYSQL_ASSOC))
   {
      ...
      if (($_SESSION['realtor']=='y' && $_SESSION['add_client']=='y') or $_SESSION['isadmin']!=0 or $_SESSION['uid']==$row['id'])
      {
        echo '<td><a class="default_link" href='.$web_app_path.'edituser.php?id='.$row['id'];
	    echo '>Edit</a></td><td><a class="default_link del_link" href="/users.php?ddel='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this user?\')">';
	    if ($row['isadmin']==0)
