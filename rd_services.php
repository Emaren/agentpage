...
<a href="/rd_editservice.php" style="float:left;margin-top:20px;" class="brown_btn addrealtor">Add Service</a>
...
<tr>
<th>&nbsp;</th>
<th><a href='<? echo $web_app_path; ?>rd_users.php?sort=0&dir=<? echo $sort_dir[0]?>'>Name&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[0].' border=0>'; ?></a></th>
<th><a href='<? echo $web_app_path; ?>rd_users.php?sort=1&dir=<? echo $sort_dir[1]?>'>Type&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[1].' border=0>'; ?></a></th>
<th><a href='<? echo $web_app_path; ?>rd_users.php?sort=1&dir=<? echo $sort_dir[2]?>'>Company&nbsp;<img src=<? echo $web_app_path.'images/'.$sort_img[2].' border=0>'; ?></a></th>
</tr>
...
<?
   while ($row=mysql_fetch_array($res,MYSQL_ASSOC))
   {
     if ($row['personimage']!='')
      ...
      echo '<td>'.$row['name'].'</td><td>'.$type[$row['typeid']-1].'</td><td>'.$row['company'].'</td><td><a class="default_link" href='.$web_app_path.'rd_editservice.php?id='.$row['id'];
	  echo '>Edit</a></td><td><a class="default_link del_link" href="/rd_services.php?ddel='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this service?\')">';
	  if ($row['isadmin']==0)
