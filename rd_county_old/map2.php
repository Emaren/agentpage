...
<map name="m6" id="m6">
  <area shape="poly" coords="1,15,4,73,27,113,37,110,39,122,47,120,48,101,53,102,51,88,60,85,58,47,47,36,46,17" href="#" id="area6" href="javascript:void(0)" onclick="showDiv('#red_deer','area6',120,1.1)" />
</map>
...
?>
<table id="twitter_table" cellpadding="0" cellspacing="0" style="top: 684px; left: 397px;">

<tr>
<td rowspan="2" valign="bottom"><? include('twitter2.php'); ?></td>
<td rowspan="2" valign="bottom" align="center" width="200"><img src="images/man.png" width="180" /></td>
...
<tr>
<td valign="bottom" height="70"><p style="color: #fff; font-size: 36px; margin: 0; font-weight: 600; text-align: center;text-shadow: 0px 1px 0px #444; line-height: 35px;">Jim Smith,<br />My REALTOR<span class="reg_symbol">&reg;</span></p></td>
</tr>
...
<a href="/rd_city/map20a.php"><img src="images/gotocity.png" class="hover" style="position:absolute; top: 597px; left: 42px; width: 113px; height: 169px;" id="area00" href="javascript:void(0)" /></a>
<a href="javascript:displayservices();"><img src="images/myservbtn.png" class="hover" style="position:absolute; top: 350px; left: 36px; height: 100px;" /></a>
<a href="javascript:displayref();"><img src="images/reficon.png" class="hover" style="position:absolute; top: 477px; left: 52px; height: 100px;" /></a>
</div>
...
<table cellpadding="0" cellspacing="0" class="mrn_footer" style="width: 1277px; min-width: 1277px; margin: 0; position: absolute; top: 1000px;">
<tr>
<td></td>
...
<td align="right">
<a class="settings_btn" href="/rd_edituser.php?id=<? echo $_SESSION['uid'];?>" style="font-family: 'Myriad Pro', Helvetica, Arial, Sans-serif; font-size: 25px; color: #fff; font-weight: 600;">My Settings</a>
</td>
</table>
