...
<?
  ...
  while ($row=mysql_fetch_array($res,MYSQL_ASSOC))
  {
	...
	echo '<td rowspan="2" style="text-align:left;" width="125"><img src="/images/'.$row2['imagename'].'.'.$row2['ext'].'" style="width: 125px;" /><div style="padding: 5px 0 0 0;"><img style="width: 20px;" src="../images/failed.png" /><a class="del_fav" href="#">delete</a></div></td>';
