...
<table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; min-height: 250px;" id="services_width">
	  ...
	  for ($j=0;$j<=$highest+1;$j++)
	  {
	    ...
	    else
	    {
		  if ($i!=4)
		    ...
		    echo '<div class="serv_break" style="border-right:none;'.$st.'">';
		  echo '<table cellpadding="0" cellspacing="0" width="100%" id="services_width">';
	      echo '<tr><td>&nbsp;</td>';
		  echo '</td></tr><tr><td colspan="2"><img /></td></tr></table></div>';
	   }
	   if ($i==5)
	   {
	     $col=0;
