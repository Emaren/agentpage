...
<script type="text/javascript">
	...
	function showDiv2(obj,area,factor)
	{
		...
		if (w>1370)
		{
		  ...
		  w=(w*.6);
		$('#info_right_grow').animate({ top:"120px",left:w,opacity: 0.8,width:'490px',height:"629px"},500,function () { showlisting(w);});
...
//		$(obj).css({'top' : pos[obj].top+'px',left: pos[obj].left,marginLeft:0,marginTop:0,width: originalWidth[obj]/factor,height: originalHeight[obj]/factor});
    ...
    function displayservices()
	{
      ...
      $('#services_grow').animate({ left:"170px",opacity: 0.8,width:"1214px"},500,function () { make_services_appear(); });
	}
...
<div>
<object style="position: absolute; left: 35px; top: 0px; z-index:5;" id="shimmer_list" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" height="200" wmode="transparent">
...
<object wmode="transparent" style="position: absolute; left: 1042px; top: -2px; z-index: 5;" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="300" id="shimmer_search" height="200">
...
<map name="m2" id="m2">
  <area shape="poly" coords="4,6,8,110,16,111,18,107,89,104,88,110,125,109,124,6,87,10,77,25,49,29,46,19,44,5" href="#" id="area2" href="javascript:void(0)" onclick="showDiv('#shape2','area2',52,1.3)">
</map>
...
<map name="m3" id="m3">
  <area shape="poly" coords="114,5,118,99,108,107,92,109,67,92,54,95,10,111,9,71,5,54,22,75,38,79,44,68,65,68,64,59,75,47,71,38,68,33,72,19,78,7" href="#" id="area3" href="javascript:void(0)" onclick="showDiv('#shape3','area3',53,1.3)">
</map>
...
<map name="m4" id="m4">
  <area shape="poly" coords="6,6,7,86,19,87,21,122,7,123,6,132,12,141,9,186,24,189,42,190,86,161,101,162,122,184,128,178,130,150,123,144,126,101,102,73,102,5" href="#" id="area4" href="javascript:void(0)" onclick="showDiv('#shape4','area4',54,1.3)">
</map>
...
<map name="m5" id="m5">
  <area shape="poly" coords="7,4,171,7,170,148,178,151,179,185,167,183,153,186,147,199,124,191,103,204,87,193,90,172,98,154,101,137,94,117,76,112,78,63,66,61,64,47,36,48,39,61,6,64" href="#" id="area5" href="javascript:void(0)" onclick="showDiv('#shape5','area5',55,1.3)">
</map>
...
<map name="m7" id="m7">
  <area shape="poly" coords="9,30,9,257,211,255,210,189,249,187,245,59,238,54,241,6,232,6,228,32,204,32,203,57,109,58,113,43,74,44,75,30" href="#" id="area7" href="javascript:void(0)" onclick="showDiv('#shape7','area7',57,1.3)">
</map>
...
<map name="m8" id="m8">
  <area shape="poly" coords="143,56,253,51,248,79,255,82,252,211,12,212,16,68,4,65,7,35,33,7,142,7" href="#" id="area8" href="javascript:void(0)" onclick="showDiv('#shape8','area8',58,1.3)">
</map>
...
<map name="m9" id="m9">
  <area shape="poly" coords="5,68,139,68,139,87,266,89,265,33,288,33,313,6,330,4,338,25,348,37,361,47,359,58,343,65,346,78,351,85,334,80,322,87,325,101,337,102,326,114,320,135,324,153,330,163,307,180,88,179,89,161,52,158,54,180,4,179" href="#" id="area9" href="javascript:void(0)" onclick="showDiv('#shape9','area9',59,1.3)">
</map>
...
<map name="m10" id="m10">
  <area shape="poly" coords="22,5,69,4,83,11,82,25,67,25,70,51,72,61,65,57,58,58,48,71,46,57,36,57,22,30,10,29,10,23,29,23,29,13" href="#" id="area10" href="javascript:void(0)" onclick="showDiv('#grande_prairie','area10',67,1.3)">
</map>
...
<tr>
<td rowspan="2" valign="bottom"><? if ($realtr['twitter_account']!='') include('twitter2.php'); ?></td>
<td rowspan="2" valign="bottom" align="center" width="200">
<?
   if ($realtr['personal_image']!='')
   {
?>
<img src="/images/man.png<? //echo $realtr['personal_image'];?>" width="180" />
<? }
else {
?>
<img src="/images/man.png" width="180" />
<?
}
?>
</td>
<td height="187" valign="bottom" align="center"><? if ($realtr['website']!='') { ?>
...
<object style="position: absolute; left: 21px; top: 411px;" id="myservlink" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="150" height="120" wmode="transparent">
...
<object style="position: absolute; left: 21px; top: 535px;" id="myreflink" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="150" height="120" wmode="transparent">
...
<td align="right">
<a class="settings_btn" href="/edituser.php?id=<? echo $_SESSION['uid'];?>" style="font-family: 'Myriad Pro', Helvetica, Arial, Sans-serif; font-size: 25px; color: #fff; font-weight: 600;">My Settings</a>
</td>
</table>
