...
<table class="search_table" cellpadding="0" cellspacing="0" width="95%" style="margin: 10px auto;">
<tr>
...
<tr id="purchase_lease" style="display:none">
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="display:block" id="pricesearch_from" name="pricesearch_from">
    ...
    <select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="display:none" id="leasepricesearch_from" name="leasepricesearch_from">
    ...
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="display:block"  id="pricesearch_to" name="pricesearch_to">
    <option value="0">$0</option>
    <option value="50">$50,000</option>
    <option value="100">$100,000</option>
    <option value="150">$150,000</option>
    ...
    <select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="display:none" id="leasepricesearch_to" name="leasepricesearch_to">
    <option value="100">$100</option>
    <option value="200">$200</option>
    <option value="300">$300</option>
    <option value="400">$400</option>
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" id="bedssearch" name="bedssearch">
		...
		<select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="sizefrom" id="sizefrom" style="display:none;width:48%;">
		...
		<select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="sizeto" id="sizeto" style="display:none;width:48%;">
    	<option value="500">500 sqft</option>
    	<option value="1000">1000 sqft</option>
    	<option value="2000">2000 sqft</option>
    	<option value="3000">3000 sqft</option>
    ...
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" id="agesearch" name="agesearch">
        <option value="any">Any</option>
  ...
  <tr>
    <td><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" style="width: 98%;" id="bathsearch" name="bathsearch">
        <option value="any">Any</option>
    	<option value="1">1+</option>
        <option value="2">2+</option>
        <option value="3">3+</option>
		...
		<select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="acresfrom" id="acresfrom" style="display:none;width:48%;">
		...
		<select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" name="acresto" id="acresto" style="display:none;width:48%;">
    	<option value="2">2 acres</option>
    	<option value="3">3 acres</option>
    	<option value="4">4 acres</option>
    	<option value="5">5 acres</option>
  ...
  <tr>
    <td colspan="2"><select mmTranslatedValueHiliteColor="HILITECOLOR=%22No Color%22" id="subdivsearch" multiple name="subdivsearch" style="height: 32px;"><option value="0">All</option>
<?
...
?>
  ...
  <tr>
    <td colspan="2"><input type="submit" value=" " onclick="callSearch();" name="searchsubmit" style="background: url(images/searchbtn.png) no-repeat; width: 133px; height: 39px; border: none;" /></td>
  </tr>
</table>
</form>
...
function callSearch()
{
  ...
  if (prce_from>prce_to)
    ...
    aj_doSearch(bds,bths,ge,grage,prce_from,prce_to,sdivision,ltype,ptype,sizefrom,sizeto,acresfrom,acresto,leaseprice_from,leaseprice_to);
  return false;
}
