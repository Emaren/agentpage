<?
  ...
  if ($_POST['post42']!='')
  {
    ...
    $sql=' update tb_subdivision set `desc`="'.htmlentities($_POST['desc'],ENT_QUOTES).'", no_of_homes="'.htmlentities($_POST['no_of_homes'],ENT_QUOTES).'", amenities="'.htmlentities($_POST['amenities'],ENT_QUOTES);
